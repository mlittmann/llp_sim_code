...
MUPLUS="/cvmfs/public-uc.osgstorage.org/ospool/uc-shared/public/futurecolliders/v5/simBIB/mp_pruned"
MUMINUS="/cvmfs/public-uc.osgstorage.org/ospool/uc-shared/public/futurecolliders/v5/simBIB/mm_pruned"

command="k4run maia_reco_steer.py --inputFile ${input_file}_sim${proc_id}.slcio --outputFile ${input_file}_reco${proc_id}.slcio --OverlayFullPathToMuPlus ${MUPLUS} --OverlayFullPathToMuMinus ${MUMINUS} --OverlayFullNumberBackground ${bib}"
