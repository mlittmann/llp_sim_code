...
command="k4run old-reco_steer.py --LcioEvent.Files ${input_file}_digi${proc_id}.slcio --outputFile ${input_file}_reco${proc_id}.slcio --MatFile ${ACTS_MatFile} --TGeoFile ${ACTS_TGeoFile}"
