...
. /opt/spack/opt/spack/__spack_path_placeholder__/__spack_path_placeholder__/__spack_path_placeholder__/__spack_path_placeholder__/linux-x86_64/mucoll-stack-master-2wtmg3ohr26uckseodhqjfjaw7mijwil/setup.sh
echo ">>>completed"
...
command="ddsim --steeringFile sim_steer_GEN_CONDOR.py --inputFile ${input_file}.hepmc --physics.pdgfile ${input_file}.tbl --outputFile ${input_file}_sim${proc_id}.slcio --numberOfEvents ${events_per_chunk} --compactFile MAIA_v0/MAIA_v0.xml --skipNEvents ${events_to_skip}"
